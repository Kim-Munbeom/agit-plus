...
class CustomConversationalRetrievalChain(ConversationalRetrievalChain):
    ...
    def _create_prompt(self, question: str, context: str, chat_history: List[BaseMessage]) -> str:
        """프롬프트 생성 메서드"""
        formatted_history = "\n".join(
...
위 문서들의 정보를 바탕으로 답변해주세요. 
1. 문서에서 찾을 수 있는 정보만을 사용하여 답변하세요.
2. 관련 정보가 문서에 없다면 '관련 정보를 찾을 수 없습니다'라고 답변하세요.
3. 답변은 명확하고 간결하게 작성하세요.
4. 가능한 경우 출처 문서를 인용하여 답변의 신뢰성을 높이세요."""
